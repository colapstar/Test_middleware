...
function useAxios(...args) {
  ...
  const cancelTokenSource = axios_default.CancelToken.source;
  ...
  const execute = (executeUrl = url, config = {}) => {
    ...
    instance(_url, __spreadProps(__spreadValues(__spreadValues({}, defaultConfig), typeof executeUrl === "object" ? executeUrl : config), { cancelToken: cancelToken.token })).then((r) => {
      ...
      data.value = result2;
      (_a2 = options.onSuccess) == null ? void 0 : _a2.call(options, result2);
    }).catch((e) => {
      var _a2;
      error.value = e;
      (_a2 = options.onError) == null ? void 0 : _a2.call(options, e);
